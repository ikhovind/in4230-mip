...
$(TARGET_PING_CLIENT): $(OBJ_ARP_CACHE) $(OBJ_MIP_BUILDER) $(OBJ_NETWORK_UTIL)  $(OBJ_PING_CLIENT)
	$(CC) $(CFLAGS) -o $(TARGET_PING_CLIENT) $(OBJ_MIP_BUILDER) $(OBJ_ARP_CACHE) $(OBJ_NETWORK_UTIL)  $(OBJ_PING_CLIENT)
...
clean:
	rm -f $(OBJ_ARP_CACHE) $(OBJ_NETWORK_UTIL)  $(OBJ_PING_CLIENT) $(OBJ_MIP_DAEMON) $(OBJ_PING_SERVER)
